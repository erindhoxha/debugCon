 var speakers = {
   speakersks: [{
       ...
       p2: `Në sistemet multiplayer të videolojave moderne, UDP protokoli përdoret për t'i lidhur lojtarët për shkak të shpejtësisë
        ...
        ta simulojnë UDP për lidhje të shpejta midis lojtarëve, me topologjitë Peer-to-peer dhe Client-Server.`,
       daysText: "",
       daysSubject: ""
     },
     {
     ...
     }, 
     {
        ...
        moment punon në Inspire11 Prishtina dhe ligjëron disa lëndë ne Universitetin e Prishtinës - FIEK.`,
        ...
        përdor teknika të Intelegjencës Artificiale (sistemet e rekomandimit) për të krijuar një ambient të personalizuar për secilin
         individ që e përdor.`,
        daysText: "",
        daysSubject: ""
    }, {
...
Ai punon si Senior Back-End Java developer në OpenResearch. Pasionet e tij në shkencat kompjuterike janë High Performance Computing, Parallel Computing, dhe Computer Graphics (Ray Tracing).`,
        ...
        'img-id': 14,
        text: `Rita Dobruna`,
        p1: `Rita punon si Android Developer në kompaninë OpenResearch. Jashtë programimit, Rita ka pasion vallëzimin, meditimin, dhe yoga.`,
